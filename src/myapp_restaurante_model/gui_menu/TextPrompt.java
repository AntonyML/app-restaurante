...
//		setBorder(new EmptyBorder(component.getInsets()));
    ...
    /**
     * Cambia el tamaño de letra de la etiqueta del TextPrompt.
     *
     * @param fontSize el nuevo tamaño de letra deseado.
     */
    ...
    /**
     * Convenience method to set the horizontal alignment of the prompt text.
     *
     * @param alignment the horizontal alignment, should be one of the
     * following: JLabel.LEFT, JLabel.CENTER, JLabel.RIGHT, JLabel.LEADING,
     * JLabel.TRAILING.
     */
