...
public final class PMEmpleado extends javax.swing.JPanel {
    ...
    public PMEmpleado() {
        ...
        String[] etiquetas = {"ID", "Nombre", "Apellido", "Apellido", "Tipo", "Balance", "foto", "Propina", "Accion"};
        this.eti = etiquetas;
        ...
        f = new FilesTxt();
        //Direcion del txt
        addressTxt = "src\\myapp_restaurante_model\\data\\empleado.txt";
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, -1, 30));
        ...
        add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 120, 40));
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, -1, 30));
        ...
        add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, 170, 40));
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, -1, 30));
        ...
        add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 170, 40));
        ...
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, -1, 30));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Apellido", "Apellido", "Tipo", "Balance", "foto", "Propina", "Accion"
            }
        ) {
        ...
        add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 220, 70, 30));
        ...
        add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, 140, 30));
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 290, -1, 20));
        ...
        add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, 70, 40));
        ...
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 340, -1, 20));
        ...
        add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 350, 110, 40));
...
//Consructor
    ...
    public void action() {
        if (jTextCodigo.getText().isEmpty()) {
            ...
            e = new Empleado(Integer.parseInt(jTextCodigo.getText()), jTextField1.getText(), jTextField2.getText(),
                    jTextField3.getText(), Integer.parseInt(jTextField4.getText()),
                    Double.parseDouble(jTextField5.getText()), jTextField6.getText(), Double.parseDouble(jTextField7.getText()));
    ...
    private void jBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBuscarMouseClicked
        ...
        if (lTxt.isId(result, jTextCodigo.getText())) {
            ...
            String tipo_Empleado = lTxt.getInformationIndividual(lTxt.getInformattionById(result, jTextCodigo.getText()))[4];
            String balance_propina = lTxt.getInformationIndividual(lTxt.getInformattionById(result, jTextCodigo.getText()))[5];
            String foto = lTxt.getInformationIndividual(lTxt.getInformattionById(result, jTextCodigo.getText()))[6];
            String propina = lTxt.getInformationIndividual(lTxt.getInformattionById(result, jTextCodigo.getText()))[7];
            ...
            jTextField4.setText(tipo_Empleado);
            jTextField5.setText(balance_propina);
            jTextField6.setText(foto);
            jTextField7.setText(propina);
