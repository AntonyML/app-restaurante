...
public final class PMMesa extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Max_Comensales");
        ...
        add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 180, 170, 40));
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 320, -1, 30));
        ...
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 240, -1, 30));
        ...
        add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, 130, 40));
        ...
        add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 340, 130, 40));
...
//Consructor
    ...
    private void jBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBuscarMouseClicked
        ...
        if (lTxt.isId(result, jTextCodigo.getText())) {
            ...
            //obtendo el correo
            String max_Comensales = lTxt.getInformationIndividual(lTxt.getInformattionById(result, jTextCodigo.getText()))[1];
            String cant_Comensales = lTxt.getInformationIndividual(lTxt.getInformattionById(result, jTextCodigo.getText()))[2];
            String estatus = lTxt.getInformationIndividual(lTxt.getInformattionById(result, jTextCodigo.getText()))[3];
            String numeros = lTxt.getInformationIndividual(lTxt.getInformattionById(result, jTextCodigo.getText()))[4];
            jTextCodigo.setEnabled(false);
            jTextField1.setEnabled(true);
            jTextField2.setEnabled(true);
            jTextField4.setEnabled(true);
            //jTextArea1.setEnabled(true);
            jTextField1.setText(max_Comensales);
            jTextField2.setText(cant_Comensales);
            jTextField3.setText(estatus);
            jTextField4.setText(numeros);
            if (!estatus.equalsIgnoreCase("false")) {
