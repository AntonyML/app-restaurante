...
public final class PMProducto extends javax.swing.JPanel {
    ...
    public PMProducto() {
        ...
        String[] etiquetas = {"ID", "Tipo", "Precio", "Existencia", "Itbis", "Accion"};
        this.eti = etiquetas;
        ...
        f = new FilesTxt();
        //Direcion del txt
        addressTxt = "src\\myapp_restaurante_model\\data\\producto.txt";
  ...
  f.EditFile(addressTxt, result);
    ...
    private void initComponents() {
        ...
        add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, 180, 40));
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, -1, 30));
        ...
        add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 150, 40));
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, -1, 30));
        ...
        add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 220, 140, 40));
        ...
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, -1, 30));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tipo", "Precio", "Existencia", "Itbis", "Accion"
            }
        ) {
        ...
        add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 280, 160, 40));
        ...
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 330, -1, 20));
        ...
        add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 340, 80, 40));
...
//Consructor
    ...
    public void action() {
        if (jTextCodigo.getText().isEmpty()) {
            ...
            p = new Producto(Integer.parseInt(jTextCodigo.getText()), jTextField1.getText(), Integer.parseInt(jTextField2.getText()),
                    Double.parseDouble(jTextField3.getText()), Double.parseDouble(jTextField4.getText()),
                    Boolean.parseBoolean(jTextField5.getText()));
  ...
  f.EditFile(addressTxt, result);
    ...
    private void jBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBuscarMouseClicked
        ...
        if (lTxt.isId(result, jTextCodigo.getText())) {
            ...
            String descripcion = lTxt.getInformationIndividual(lTxt.getInformattionById(result, jTextCodigo.getText()))[1];
            String tipo = lTxt.getInformationIndividual(lTxt.getInformattionById(result, jTextCodigo.getText()))[2];
            String precio = lTxt.getInformationIndividual(lTxt.getInformattionById(result, jTextCodigo.getText()))[3];
            String existencia = lTxt.getInformationIndividual(lTxt.getInformattionById(result, jTextCodigo.getText()))[4];
            String itbis = lTxt.getInformationIndividual(lTxt.getInformattionById(result, jTextCodigo.getText()))[5];
