...
public final class PMUsuarios extends javax.swing.JPanel {
    ...
    public PMUsuarios() {
        ...
        size = lTxt.getNumberPerson(lTxt.getInformation(addressTxt));
//Se obtiene el contenido del txt
        OTableInformation = lTxt.getObject(size, f.readFile(addressTxt));
    ...
    //tabla para editar
    public void editarTabla(Object dates[][]) {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (jTextField1.getText().equals("") && jTextField2.getText().equals("")
            ...
            JOptionPane.showMessageDialog(null, result);
            // g.dispose();
            // ControllerClients controllerClients = new ControllerClients(addressTxt);
            size = lTxt.getNumberPerson(lTxt.getInformation(result));
            ...
            //f.EditFile("src\\data\\Clientes.txt", addressTxt);
        }
