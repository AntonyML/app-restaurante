...
public final class PPCancelarReserva extends javax.swing.JPanel {
    ...
    public PPCancelarReserva() {
        ...
        String[] etiquetas = {"ID", "max", "Comensales", "Status", "numero"};
        this.eti = etiquetas;
...
//Consructor
    ...
    public void action() {
        ...
        } else {                                                                   //info de mesa      //id de mesa
            String max_Comensales = lTxt.getInformationIndividual(lTxt.getInformattionById(result, idMesa))[1];
            String cant_Comensales = lTxt.getInformationIndividual(lTxt.getInformattionById(result, idMesa))[2];
            String estatus = lTxt.getInformationIndividual(lTxt.getInformattionById(result, idMesa))[3];
            String numeros = lTxt.getInformationIndividual(lTxt.getInformattionById(result, idMesa))[4];

            m = new Mesa(Integer.parseInt(jTextCodigo.getText()), Integer.parseInt(max_Comensales), Integer.parseInt(cant_Comensales),
                    Boolean.parseBoolean(estatus), Integer.parseInt(numeros));

            result = lTxt.editInformation(result, Integer.parseInt(idMesa), m.toString());
    ...
    private void jBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBuscarMouseClicked
        ...
        //Direcion del txt
        String addressTxtReserva = "src\\myapp_restaurante_model\\data\\reserva.txt";
        //Se obtiene el tamaño del txt

        String resultReserva = f.readFile(addressTxtReserva);
        String id = lTxt.getInformationIndividual(lTxt.getInformattionById(resultReserva, jTextCodigo.getText()))[0];
        //JOptionPane.showConfirmDialog(null, id);

        if (lTxt.isId(resultReserva, jTextCodigo.getText())) {
            JOptionPane.showMessageDialog(null, "Reservando");

            //obtendo el los datos segun la posicion 
            idMesa = lTxt.getInformationIndividual(lTxt.getInformattionById(resultReserva, jTextCodigo.getText()))[3];
